// program to test a DHT module or a DHT naked senosor on the IoT Proto Shield Plus
...
// this sketch needs DHT sensor library 

#include <DHT.h>;

//Constants
#define DHT_PIN 9         // NANO data pin connecte dto DHT sensor
