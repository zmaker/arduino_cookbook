...
void printParameters(struct Configuration configuration) {
    ...
    Serial.print(F("HEAD BIN: "));  Serial.print(configuration.HEAD, DEC);Serial.print(" ");Serial.print(configuration.HEAD, DEC);Serial.print(" ");Serial.println(configuration.HEAD, HEX);
    Serial.println(F(" "));
